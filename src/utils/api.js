...
async function sendRequest(method, path, body) {
  ...
  try {
    ...
    const headers = getRequestHeaders(body, endpoint);
    const options = body
...
function getRequestHeaders(body, endpoint) {
  const headers = body
    ? { 'Accept': 'application/json', 'Content-Type': 'application/json', 'app-name': apiEndpoints.appName }
